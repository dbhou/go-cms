...
func init() {
	beego.Router("/home", &home.HomeController{})
	...
	beego.Router("/public/logout", &rbac.PublicController{}, "*:Logout")
	beego.Router("/public/changepwd", &rbac.PublicController{}, "*:Changepwd")
